...
export const PRODUTOS: Produto[] = [
  ...
  {
    id: 16,
    name: "Mouse Gamer Redragon k1ng 1K, 12400DPI, 5 Botoes, Preto, M724",
    price: 199.99,
    desc: 115.98,
    parcel: 136.45,
    img: "https://media.pichau.com.br/media/catalog/product/cache/2f958555330323e505eba7ce930bdf27/m/7/m724.jpg",
    rating: 4.5,
    descricao: [
      "Marca: Redragon",
      "Modelo: M724",
      "Características: Mouse gamer ultraleve pesando apenas 42g sem a necessidade de furos na estrutura.",
      "Formato ambidestro com botões laterais na parte esquerda.",
      "Sensor: PAW3327",
      "DPI: 200 DPI Até 12400 DPI",
      "Polling Rate: Até 1000 Hz",
      "Botões Programáveis: 5",
      "Shape: Ambidestro",
      "Design: Ultraleve sem furos",
      "Switches Principais: Huano Blue Shell White dot",
      "Codificador do scroll: F-Switch",
      "Iluminação: Não",
      "Comprimento do cabo: 1.5 m",
      "Tipo de cabo: Paracord USB Tipo-C",
      "Software: Sim",
      "Materiais: Plástico",
      "Conectividade: USB Tipo-C",
      "Peso: 42 g",
      "Dimensões aproximadas: 121 x 64 x 38 mm"
    ],
    categoria: "mouse",
    isPromocao: false,
    stock: 50,
  ...
  {
    id: 17,
    name: "Placa Mae Pichau Danuri B550M-PX, DDR4, Socket AM4, M-ATX, Chipset AMD B550, PCH-DNRB550M-PX",
    price: 1176.46,
    desc: 579.99,
    parcel: 682.34,
    img: "https://media.pichau.com.br/media/catalog/product/cache/2f958555330323e505eba7ce930bdf27/p/c/pch-dnrb550m-px.jpg",
    rating: 4.5,
    descricao: [
      "Marca: Pichau",
      "Modelo: PCH-DNRB550M-PX",
      "CPU: Socket AM4, suporte para AMD Ryzen 3000 até 5000 series",
      "Com atualização de BIOS, suporta os processadores com vídeo integrado da geração 3000",
      "Chipset: B550",
      "BIOS: AMI 128Mbit, suporta inicialização sem disco, ativação na LAN, inicialização e outras funções",
      "Memória: 2 x Slots DDR4 DIMM, máximo de 64GB (máx. 32 GB cada slot), DDR4 2400/2666/2933/3200/3800 MHz",
      "Arquitetura de memória: Dual Channel",
      "Gráfico: 1 x Porta VGA, suportando uma resolução máxima de 1920x1080@60Hz",
      "Gráfico: 1 x Porta HDMI, suportando uma resolução máxima de 3840x2160@30Hz",
      "Áudio: Codec Realtek® ALC897",
      "Áudio: Suporta reprodução de até 24 bits/192 kHz",
      "Recursos de áudio: Blindagem de áudio",
      "Recursos de áudio: Capacitores de áudio premium",
      "LAN: Realtek® RTL8111H 1000 Mbps"
    ],
  ...
  {
    id: 18,
    name: "Teclado Mecanico Redragon Phantom, RGB, Switch Marrom, Preto, K629-RGB-PT-BROWN",
    price: 372.99,
    desc: 295.99,
    parcel: 348.22,
    img: "https://media.pichau.com.br/media/catalog/product/cache/2f958555330323e505eba7ce930bdf27/k/6/k629-rgb-pt-brown8.jpg",
    rating: 4.5,
    descricao: [
      "Marca: Redragon",
      "Modelo: K629-RGB-PT-BROWN",
      "Características: Teclado no formato 75%.",
      "Iluminação: RGB Redragon Chroma Mk.II individual.",
      "Keycaps: Double shot injection de qualidade superior para maior longevidade.",
      ...
      "Comprimento do cabo: 1.5m aproximadamente",
